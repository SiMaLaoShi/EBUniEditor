...
<root>
  ...
  ├── Editor
  │   ├── Undefined.Ebunieditor.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Undefined.Ebunieditor.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Undefined.Ebunieditor.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Undefined.Ebunieditor.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Undefined.Ebunieditor`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package EBUniEditor Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Undefined.Ebunieditor.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Undefined.Ebunieditor.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Undefined.Ebunieditor.Editor.Tests.asmdef`

  `Tests/Runtime/Undefined.Ebunieditor.Tests.asmdef`
