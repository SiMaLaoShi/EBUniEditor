...
namespace EBUniEditor.Editor.Inspector
{
    ...
    /// </summary>
    public abstract class UnityProvideEditor : UnityEditor.Editor
    {
        MethodInfo _onSceneGUI;
        MethodInfo _onHeaderGUI;
        UnityEditor.Editor _provideEditor;
        ...
        protected virtual void OnEnable()
        {
            ...
            _provideEditor = UnityEditor.Editor.CreateEditor(targets, provideEditorType);
